...
byte TypeCircuits[] ={Persiana,Piloto};
byte TypeInputs[] ={Button,Button,Button,Swicth,Swicth,Swicth,Swicth,Swicth,Swicth,Swicth};
/***********************************************************************************************************************/
/***********************************************************************************************************************/
/***********************************************************************************************************************/
/***********************************************************************************************************************/
...
//AUTO GENERATED CODE
/*************************************************************/
  Sensors[0].Device_Number =240;//Sensor
  circuits [0].Device_Number =0;//Circuit 0
...
/*************************************************************/
  ...
  //CIRCUITO NUMERO 0
  //Circuit 0
  if (NumberInput==1){if (OutUpPersiana[0]||OutDowPersiana[0]){GestionMovPersianas(0);circuits[0].Value=PosicionPersiana[0];}else {circuits[0].Value=100;}}
  if (NumberInput==2){if (OutUpPersiana[0]||OutDowPersiana[0]){GestionMovPersianas(0);circuits[0].Value=PosicionPersiana[0];}else {circuits[0].Value=0;}}

  //CIRCUITO NUMERO 1
  //Circuit 1
  if (NumberInput==0){if (circuits[1].Value > 0){circuits[1].Value=0;}else{circuits[1].Value=1;}}
/*************************************************************/
//END GENERATED CODE
/*************************************************************/
...
/*************************************************************/
  ...
  //CIRCUITO NUMERO 0
  //Circuit 0
  if (NumberInput==1){InUpPersiana[0]=false;InDowPersiana[0]=false;}

  if (NumberInput==2){InUpPersiana[0]=false;InDowPersiana[0]=false;}
...
/*************************************************************/
  ...
  //CIRCUITO NUMERO 0
  //Circuit 0
  if (NumberInput==1){circuits[0].Value=PosicionPersiana[0];InUpPersiana[0]=true;InDowPersiana[0]=false;}

  if (NumberInput==2){circuits[0].Value=PosicionPersiana[0];InUpPersiana[0]=false;InDowPersiana[0]=true;}
...
void SetRelay(byte Pin, boolean On){if (On){digitalWrite(Pin,LOW);}else{digitalWrite(Pin,HIGH);}}
...
/*************************************************************/
  ...
  //Circuit 0
   // Out 2
  SetRelay(PinOutput[0],circuits[0].Out2_Value);
  if (circuits[0].Out1_Value){if (circuits[0].OldValue==0){circuits[0].OldValue=1;delay(150);}}else{circuits[0].OldValue=0;}
  //Out 1
  SetRelay(PinOutput[3],circuits[0].Out1_Value);

  //CIRCUITO NUMERO 1
  //Circuit 1
  //Out 1
  SetRelay(PinOutput[2],circuits[1].Out1_Value);
